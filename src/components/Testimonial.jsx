...
const TestimonialSec = () => {
  const testimonials = [
    {
      avatar:
        "https://cdn-images.kyruus.com/providermatch/phs/photos/orig/landry-joel-1982669719.jpg",
      name: "Adam J. Bruggeman, MD, MHA",
      title: "Board-Certified Orthopedic Surgeon & CEO",
      quote:
        "What I get out of this patient acquisition program is consistency. I know where my patients are going to come from, and I know how they’re going to come in. It makes things so much easier for us to work through in clinic.",
    },
    {
      avatar:
        "https://cdn.providence.org/asset/9Pc7n6juZ7XdribFJ9FxNA1372173797/providermatch/phs/photos/orig/turpin-kathryn-1629400387/jpg",
      name: "Kathryn M. Turpin, PT",
      title:
        "Orthopedic Physical Therapy Physical Therapy Providence Outpatient Orthopedic Therapy - Southern Oregon",
      quote:
        "Very responsive. Kept me in the loop. I would recommend working with RIPPLE on web design and for SEO. Extra points for being based in Texas!",
    },
    {
      avatar:
        "https://cdn-images.kyruus.com/providermatch/phs/photos/orig/lund-james-1033108709.jpg",
      name: "James A. Lund, MD",
      title:
        "Internal Medicine - Pacific Medical Centers Primary Care - Totem Lake",
      quote:
        "Ruth & crew did a great job for me at a reasonable price. Got the job done quickly & built exactly what I was looking for. Drove business to our clinic's site that would otherwise not have been available and the website paid for itself quickly.",
    },
  ];

  return (
    <section className="relative py-14" id="Testimonial">
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-xl sm:text-center md:mx-auto">
          <h3 className="text-3xl text-red-500 font-semibold">Testimonials</h3>
          ...
          <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((item, idx) => (
              <li key={idx} className="bg-white rounded-xl border shadow-md">
                ...
                <figure>
                  <blockquote>
                    <p className="text-gray-800 text-lg italic font-semibold px-4 py-1">
                      {item.quote}
                    </p>
                  </blockquote>
      ...
      <div className='bg-cover bg-center bg-[url("https://i.ibb.co/74xHNbc/pexels-cedric-fauntleroy-4269494.jpg")] absolute top-0 w-full h-[350px]'></div>
    </section>
  );
};
